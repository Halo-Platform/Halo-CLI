...
using Halo.Persistence.LevelDB;
using Halo.Plugins;
using Halo.Services;
using Halo.SmartContract;
using Halo.VM;
using Halo.Wallets;
using Halo.Wallets.NEP6;
using Halo.Wallets.SQLite;
using Neo.VM;
using System;
...
using ECCurve = Halo.Cryptography.ECC.ECCurve;
using ECPoint = Halo.Cryptography.ECC.ECPoint;
...
namespace Halo.Shell
{
    internal class MainService : ConsoleServiceBase
    {
        ...
        private SandSystem system;
        private WalletIndexer indexer;

        protected override string Prompt => "Halo";
        public override string ServiceName => "Halo";
        ...
        private bool OnInstallCommand(string[] args)
        {
            ...
            Console.WriteLine($"Install successful, please restart Halo-CLI.");
            return true;
        }
        ...
        private bool OnUnInstallCommand(string[] args)
        {
            ...
            Console.WriteLine($"Uninstall successful, please restart Halo-CLI.");
            return true;
        }
